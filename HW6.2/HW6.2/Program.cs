...
а) подсчитать сколько студентов в возрасте от 18 до 20 лет на каком курсе учатся (*частотный массив);
б) отсортировать список по возрасту студента;
в) *отсортировать список по курсу и возрасту студента;
 * 
 * Юрий Бойцун
 */
